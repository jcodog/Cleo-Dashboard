    ...
    <>
      ...
      >
        ...
        <Image
          ...
          className="absolute inset-0 object-cover z-5"
        />
        <div className="absolute inset-0 z-10 flex items-center justify-center text-pretty truncate overflow-hidden bg-background/60 backdrop-blur-sm border-t border-white/10 opacity-0 animate-out slide-out-to-bottom group-hover:opacity-100 group-hover:animate-in group-hover:slide-in-from-bottom duration-250 p-4">
