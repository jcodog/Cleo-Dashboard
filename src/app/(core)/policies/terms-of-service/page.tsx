    ...
    <section className="flex flex-1 flex-col items-start justify-start gap-4 p-6 max-w-3xl mx-auto">
      ...
      <div className="flex flex-col gap-4">
        <div>
          ...
          <p>
            By accessing and using the Cleo Dashboard (&quot;Service&quot;), you
            acknowledge and agree to be bound by these Terms of Service.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>
            Cleo reserves the right to modify or discontinue the Service at any
            time without notice.
          </p>
        </div>
        <div>
